...
wchar_t* ConvertCharToWChar(char* charArray) {
...
DWORD find_process_id(wchar_t* process) {
...
int main(int argc, char* argv[]) {
    ...
    char* process = argv[1];
    wchar_t* processWchar = ConvertCharToWChar(process);
    DWORD P_ID = find_process_id(processWchar);
    if (P_ID == 0) {
